...
#metricSource = 'IRIS'
metadataSource = 'IRIS'
metricSource = '/Users/ken/quarg/ak_bdf.db'
#metadataSource = '/Users/ken/quarg/all.xml' 
#metadataSource = '/Users/ken/quarg/ELK.xml'

## Thresholds:
thresholdGroups = ['Completeness', 'Amplitudes']
##thresholdGroups = ['Completeness', 'State of Health', 'Timing', 'Amplitudes', 'Metadata']

groupsDict = {'Completeness': ['avgGaps', 'gapsRatioGt12', 'noData'], 'Amplitudes': ['hiAmp',  'flat', 'lowRms'], 'Metadata': ['horDip', 'lowScale', 'nonMSUnits', 'zDip', 'zeroZ']}
