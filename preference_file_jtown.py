...
groupsDict = {'Completeness': ['avgGaps', 'gapsRatioGt12', 'noData'], 'Amplitudes': ['noise1', 'noise2', 'hiAmp', 'lowAmp', 'flat', 'nSpikes', 'avgSpikes', 'lowRms', 'badResp', 'badResp2', 'pegged', 'dead', 'xTalk', 'arrayRms'], 'Metadata': ['horDip', 'lowScale', 'nonMSUnits', 'zDip', 'zeroZ']}
